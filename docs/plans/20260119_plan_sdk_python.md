...
**Reference**: [Design Document](../design/20260119_design_sdk_python.md)
...
- [x] Implement `sdk-rust/flovyn/_native/loader.py`:
...
- [x] Create `sdk-rust/flovyn/exceptions.py`:
  ...
  - `PromiseTimeout`
  - `PromiseRejected`
- [x] Create `sdk-rust/flovyn/serde.py`:
...
- [x] Create `sdk-rust/flovyn/task.py`:
...
- [x] Create `sdk-rust/flovyn/context.py` (TaskContext portion):
...
- [x] Create `sdk-rust/flovyn/workflow.py`:
...
- [x] Extend `sdk-rust/flovyn/context.py` (WorkflowContext portion):
...
- [x] Create `sdk-rust/flovyn/worker.py`:
...
- [x] Create `sdk-rust/flovyn/client.py`:
  - `FlovynClientBuilder`:
...
- [x] Create `sdk-rust/flovyn/hooks.py`:
...
- [x] Update `sdk-rust/flovyn/__init__.py` with all public exports:
...
- [x] Create `sdk-rust/flovyn/testing/__init__.py`
- [x] Create `sdk-rust/flovyn/testing/mocks.py`:
  - `MockWorkflowContext`:
...
- [x] Create `sdk-rust/flovyn/testing/environment.py`:
...
- [x] Create `sdk-rust/tests/e2e/__init__.py`
- [x] Create `sdk-rust/flovyn/testing/environment.py` (TestHarness class):
...
- [x] Create `sdk-rust/tests/e2e/fixtures/__init__.py`
- [x] Create `sdk-rust/tests/e2e/fixtures/workflows.py`:
...
- [x] Create `sdk-rust/tests/e2e/fixtures/tasks.py`:
...
- [x] Create `sdk-rust/tests/e2e/test_workflow.py`:
...
- [x] Create `sdk-rust/tests/e2e/test_task.py`:
...
- [x] Create `sdk-rust/tests/e2e/fixtures/workflows.py` additions:
...
- [x] Create `sdk-rust/tests/e2e/test_promise.py`:
...
- [x] Create `sdk-rust/tests/e2e/test_child_workflow.py`:
...
- [x] Create `sdk-rust/tests/e2e/test_lifecycle.py`:
...
- [x] Create `sdk-rust/tests/e2e/test_replay.py`:
...
- [x] Create `sdk-rust/tests/e2e/test_parallel.py`:
...
- [x] Create `sdk-rust/examples/hello_world.py`:
  - Simple workflow and task
  - FlovynClient setup
  - Start workflow and print result
- [x] Create `sdk-rust/examples/order_processing.py`:
  - Multi-step workflow
  - Multiple tasks (validate, payment, fulfillment)
  - State management
  - Error handling
- [ ] Create `sdk-rust/examples/data_pipeline.py`:
...
- [x] Create `sdk-rust/bin/download-ffi.sh` script matching sdk-kotlin:
...
- `sdk-rust/_native/loader.py` - Native library loading
...
- `sdk-rust/fixtures/workflows.py` - 13 test workflows
- `sdk-rust/fixtures/tasks.py` - 5 test tasks
...
- `sdk-rust/bin/download-ffi.sh` - FFI download script (matching sdk-kotlin)
...
**Root Cause**: Two problems in `sdk-rust/worker-ffi/src/context.rs`:
...
**Root Cause**: Three issues in `sdk-rust/worker-ffi/src/context.rs`:
...
- `sdk-rust/testing/mocks.py` - Added `StreamEvent`, streaming to `MockTaskContext`
- `sdk-rust/testing/environment.py` - Added lifecycle properties and info methods
...
- `sdk-rust/testing/environment.py` - Mirrored all methods
...
- [x] Created `sdk-rust/bin/download-ffi.sh` script matching sdk-kotlin
