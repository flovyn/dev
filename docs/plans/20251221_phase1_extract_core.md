...
- [x] Create minimal `sdk-rust/core/src/lib.rs` with module declarations
- [x] Add `flovyn-core` as dependency in `sdk-rust/sdk/Cargo.toml`
...
- [x] Update `sdk-rust/core/src/lib.rs` to expose `generated` module
- [x] Update `sdk-rust/sdk/src/lib.rs` to re-export `flovyn_core::generated`
...
- [x] Create `sdk-rust/core/src/error.rs` with core error types
...
- [x] Create `sdk-rust/core/src/workflow/mod.rs`
- [x] Move `sdk-rust/sdk/src/workflow/command.rs` to `sdk-rust/core/src/workflow/command.rs`
- [x] Move `sdk-rust/sdk/src/workflow/event.rs` (ReplayEvent) to `sdk-rust/core/src/workflow/event.rs`
...
- [x] Move `sdk-rust/sdk/src/workflow/recorder.rs` to `sdk-rust/core/src/workflow/recorder.rs`
...
- [x] Move `sdk-rust/sdk/src/worker/determinism.rs` to `sdk-rust/core/src/worker/determinism.rs`
- [x] Create `sdk-rust/core/src/worker/mod.rs`
- [x] Update imports and re-exports
- [x] Verify: `cargo test --workspace` passes
...
- [x] Create `sdk-rust/core/src/workflow/execution.rs` with language-agnostic utilities
...
- [x] Update `sdk-rust/core/src/workflow/mod.rs` to export execution utilities
- [x] Verify: `cargo test --workspace` passes
...
- [x] Create `sdk-rust/core/src/task/mod.rs`
- [x] Create `sdk-rust/core/src/task/execution.rs` with language-agnostic types:
...
- [x] Update `sdk-rust/core/src/lib.rs` to export task types
- [x] Verify: `cargo test --workspace` passes
...
- [x] Create `sdk-rust/core/src/worker/lifecycle/types.rs` with:
...
- [x] Create `sdk-rust/core/src/worker/lifecycle/events.rs` with:
  - `WorkType` - workflow/task enum
  - `WorkerLifecycleEvent` - lifecycle event enum
- [x] Create `sdk-rust/core/src/worker/lifecycle/metrics.rs` with:
  - `WorkerMetrics` - runtime metrics struct with recording methods
- [x] Create `sdk-rust/core/src/worker/lifecycle/reconnection.rs` with:
  - `ReconnectionStrategy` - reconnection strategy enum (without async trait)
- [x] Update `sdk-rust/core/src/worker/mod.rs` to export lifecycle types
...
- [x] Create `sdk-rust/core/src/client/auth.rs` with `WorkerTokenInterceptor`
- [x] Create `sdk-rust/core/src/client/task_execution.rs` with `TaskExecutionClient`
- [x] Create `sdk-rust/core/src/client/workflow_dispatch.rs` with `WorkflowDispatch`
- [x] Create `sdk-rust/core/src/client/workflow_query.rs` with `WorkflowQueryClient`
- [x] Create `sdk-rust/core/src/client/worker_lifecycle.rs` with `WorkerLifecycleClient`
- [x] Create `sdk-rust/core/src/error.rs` with `CoreError` and `CoreResult`
- [x] Move task streaming types to `core/src/task/streaming/`
- [x] Add `WorkflowMetadata` to `sdk-rust/core/src/workflow/execution.rs`
...
- [x] Update SDK's `sdk-rust/client/mod.rs` to re-export from `flovyn_core::client`
- [x] Update SDK's `sdk-rust/task/streaming/mod.rs` to re-export from `flovyn_core::task::streaming`
...
| `sdk-rust/sdk/src/workflow/command.rs` | `sdk-rust/core/src/workflow/command.rs` | |
| `sdk-rust/sdk/src/workflow/event.rs` | `sdk-rust/core/src/workflow/event.rs` | |
| `sdk-rust/sdk/src/workflow/recorder.rs` | `sdk-rust/core/src/workflow/recorder.rs` | |
| `sdk-rust/sdk/src/workflow/context_impl.rs` | `sdk-rust/core/src/workflow/execution.rs` | Refactored |
| `sdk-rust/sdk/src/workflow/definition.rs` | `sdk-rust/sdk/src/workflow/definition.rs` | Stays in sdk |
| `sdk-rust/sdk/src/workflow/context.rs` | `sdk-rust/sdk/src/workflow/context.rs` | Stays in sdk (trait) |
| `sdk-rust/sdk/src/workflow/future.rs` | `sdk-rust/sdk/src/workflow/future.rs` | Stays in sdk |
| `sdk-rust/sdk/src/workflow/combinators.rs` | `sdk-rust/sdk/src/workflow/combinators.rs` | Stays in sdk |
| `sdk-rust/sdk/src/task/executor.rs` | `sdk-rust/core/src/task/execution.rs` | Core logic extracted |
| `sdk-rust/sdk/src/task/registry.rs` | `sdk-rust/core/src/task/registry.rs` | |
| `sdk-rust/sdk/src/task/definition.rs` | `sdk-rust/sdk/src/task/definition.rs` | Stays in sdk |
| `sdk-rust/sdk/src/task/context.rs` | `sdk-rust/sdk/src/task/context.rs` | Stays in sdk (trait) |
| `sdk-rust/sdk/src/worker/determinism.rs` | `sdk-rust/core/src/worker/determinism.rs` | |
| `sdk-rust/sdk/src/worker/workflow_worker.rs` | `sdk-rust/core/src/worker/workflow_worker.rs` | |
| `sdk-rust/sdk/src/worker/task_worker.rs` | `sdk-rust/core/src/worker/task_worker.rs` | |
| `sdk/src/worker/lifecycle/` | `core/src/worker/lifecycle/` | Entire directory |
| `sdk-rust/sdk/src/worker/executor.rs` | `sdk-rust/sdk/src/worker/executor.rs` | Stays (uses traits) |
| `sdk-rust/sdk/src/worker/registry.rs` | `sdk-rust/core/src/worker/registry.rs` | |
| `sdk-rust/sdk/src/client/workflow_dispatch.rs` | `sdk-rust/core/src/client/workflow_dispatch.rs` | |
| `sdk-rust/sdk/src/client/task_execution.rs` | `sdk-rust/core/src/client/task_execution.rs` | |
| `sdk-rust/sdk/src/client/worker_lifecycle.rs` | `sdk-rust/core/src/client/worker_lifecycle.rs` | |
| `sdk-rust/sdk/src/client/auth.rs` | `sdk-rust/core/src/client/auth.rs` | |
| `sdk-rust/sdk/src/client/flovyn_client.rs` | `sdk-rust/sdk/src/client/flovyn_client.rs` | Stays in sdk |
| `sdk-rust/sdk/src/client/builder.rs` | `sdk-rust/sdk/src/client/builder.rs` | Stays in sdk |
