...
**File:** `sdk-rust/sdk/tests/unit/mutation_tests.rs` (new file)
...
**File:** `sdk-rust/sdk/tests/unit/mutations/mod.rs` (new file)
...
### Phase 1: Manual Mutation Tests
- [x] Create `sdk-rust/sdk/tests/unit/mutations/mod.rs`
