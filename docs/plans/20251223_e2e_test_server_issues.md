...
**Files to modify:**
- `sdk-rust/server/app/src/main/resources/application.yml`
...
**Files to modify:**
- `sdk-rust/server/app/src/main/kotlin/ai/flovyn/config/SecurityConfig.kt`
...
**Files to modify:**
- `sdk-rust/server/app/src/main/kotlin/ai/flovyn/config/SecurityConfig.kt` (or new `JwtConfig.kt`)
- `sdk-rust/server/app/src/main/resources/application.yml`
...
The E2E test harness (`sdk-rust/sdk/tests/e2e/harness.rs`) currently:
