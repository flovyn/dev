...
- [x] **1.1** Create `sdk-rust/sdk/src/worker/lifecycle/mod.rs` module structure
  - Add `mod lifecycle;` to `sdk-rust/sdk/src/worker/mod.rs`
...
- Types are exported from `sdk-rust/sdk/src/lib.rs` or `prelude.rs`
...
- [x] **3.1** Create `WorkerInternals` struct in `sdk-rust/lifecycle/internals.rs`
  ```rust
...
- [x] **4.3** Write E2E test: `test_worker_status_transitions`
  ...
  - Implemented in `sdk-rust/tests/e2e/lifecycle_tests.rs`
...
Create test utilities in `sdk-rust/sdk/src/testing/lifecycle.rs`:
```rust
...
### New Files
- `sdk-rust/sdk/src/worker/lifecycle/mod.rs`
- `sdk-rust/sdk/src/worker/lifecycle/types.rs`
- `sdk-rust/sdk/src/worker/lifecycle/events.rs`
- `sdk-rust/sdk/src/worker/lifecycle/hooks.rs`
- `sdk-rust/sdk/src/worker/lifecycle/metrics.rs`
- `sdk-rust/sdk/src/worker/lifecycle/reconnection.rs`
- `sdk-rust/sdk/src/worker/lifecycle/internals.rs`
- `sdk-rust/sdk/src/testing/lifecycle.rs`
- `sdk-rust/tests/e2e/test_worker_lifecycle.rs`
- `sdk-rust/tests/e2e/test_worker_reconnection.rs`
- `examples/lifecycle-monitoring/`
- `examples/health-check-worker/`
- `examples/maintenance-worker/`

### Modified Files
- `sdk-rust/sdk/src/worker/mod.rs` - Add lifecycle module
- `sdk-rust/sdk/src/worker/workflow_worker.rs` - Integrate WorkerInternals
- `sdk-rust/sdk/src/worker/task_worker.rs` - Integrate WorkerInternals
- `sdk-rust/sdk/src/client/flovyn_client.rs` - New methods, store handle
- `sdk-rust/sdk/src/client/builder.rs` - Hook registration, reconnection config
- `sdk-rust/sdk/src/lib.rs` or `sdk-rust/sdk/src/prelude.rs` - Export new types
