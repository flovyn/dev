...
**File:** `sdk-rust/sdk/src/workflow/future.rs` (new file)
...
**File:** `sdk-rust/sdk/src/workflow/future.rs`
...
**File:** `sdk-rust/sdk/src/workflow/mod.rs`
...
**File:** `sdk-rust/sdk/src/workflow/context.rs`
...
**File:** `sdk-rust/sdk/src/workflow/context_impl.rs`
...
**File:** `sdk-rust/sdk/src/workflow/command.rs`
...
**File:** `sdk-rust/sdk/src/workflow/event.rs`
...
**File:** `sdk-rust/sdk/src/workflow/combinators.rs` (new file)
...
**File:** `sdk-rust/sdk/src/workflow/combinators.rs`
...
**File:** `sdk-rust/sdk/src/workflow/future.rs` (module tests)
...
**File:** `sdk-rust/sdk/src/workflow/context_impl.rs` (module tests)
...
**File:** `sdk-rust/sdk/src/workflow/combinators.rs` (module tests)
...
**File:** `sdk-rust/sdk/tests/tck/determinism_corpus.rs`
...
**File:** `sdk-rust/sdk/tests/e2e/fixtures/parallel_workflows.rs` (new file)
...
**File:** `sdk-rust/sdk/tests/e2e/parallel_tests.rs` (new file)
...
**File:** `sdk-rust/sdk/tests/e2e/mod.rs`
...
**File:** `sdk-rust/sdk/src/testing/mock_context.rs`
...
**File:** `sdk-rust/sdk/src/testing/mock_future.rs` (new file)
...
**File:** `sdk-rust/examples/patterns/src/parallel_workflow.rs` (new file)
...
**File:** `sdk-rust/examples/patterns/src/parallel_tasks.rs` (new file)
...
**File:** `sdk-rust/examples/patterns/src/main.rs`
...
**File:** `sdk-rust/examples/patterns/src/parallel_workflow.rs` (module tests)
...
**File:** `sdk-rust/examples/README.md`
...
### Phase 1: Future Types and CancellableFuture Trait
- [x] Create `sdk-rust/sdk/src/workflow/future.rs`
...
- [x] Export from `sdk-rust/sdk/src/workflow/mod.rs`
...
### Phase 4: Parallel Combinator Methods
- [x] Create `sdk-rust/sdk/src/workflow/combinators.rs`
...
### Phase 7: E2E Tests
- [x] Create `sdk-rust/sdk/tests/e2e/fixtures/parallel_workflows.rs` (workflows added to existing workflows.rs)
...
- [x] Create `sdk-rust/sdk/tests/e2e/parallel_tests.rs`
...
- [x] Update `sdk-rust/sdk/tests/e2e/mod.rs`

### Phase 8: MockWorkflowContext Updates
- [x] Add async methods to `MockWorkflowContext`
- [ ] Create `sdk-rust/sdk/src/testing/mock_future.rs` (not needed - using actual futures with dummy contexts)
...
**Parallel workflows:**
- [x] Create `sdk-rust/examples/patterns/src/parallel_workflow.rs`
...
**Parallel tasks:**
- [x] Create `sdk-rust/examples/patterns/src/parallel_tasks.rs`
...
**Integration:**
- [x] Update `sdk-rust/examples/patterns/src/main.rs` with new modules
...
- [x] Update `sdk-rust/examples/README.md` with parallel patterns section
