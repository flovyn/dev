...
- [ ] **1.1** Create `sdk-rust/sdk/src/workflow/suspension.rs`:
  ```rust
...
- [ ] **1.2** Add module to `sdk-rust/sdk/src/workflow/mod.rs`
...
- [ ] **6.1** Update unit tests in `sdk-rust/sdk/src/error.rs`
