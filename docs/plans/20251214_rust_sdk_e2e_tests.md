...
Update `sdk-rust/sdk/Cargo.toml`:
...
**File: `sdk-rust/tests/e2e/harness.rs`**
...
**File: `sdk-rust/tests/e2e/workflow_tests.rs`**
...
**File: `sdk-rust/tests/e2e/task_tests.rs`**
...
**File: `sdk-rust/tests/e2e/state_tests.rs`**
...
**File: `sdk-rust/tests/e2e/timer_tests.rs`**
...
**File: `sdk-rust/tests/e2e/promise_tests.rs`**
...
**File: `sdk-rust/tests/e2e/child_workflow_tests.rs`**
...
**File: `sdk-rust/tests/e2e/replay_tests.rs`**
...
**File: `sdk-rust/tests/e2e/error_tests.rs`**
...
**File: `sdk-rust/tests/e2e/concurrency_tests.rs`**
...
**Solution**:
1. Created `TaskSubmitter` trait (`sdk-rust/sdk/src/workflow/task_submitter.rs`)
...
- [x] Add testcontainers dependencies to `sdk-rust/sdk/Cargo.toml` (include `reqwest`, `jsonwebtoken`, `chrono`)
- [x] Create `sdk-rust/tests/e2e/mod.rs` entry point
- [x] Implement `sdk-rust/tests/e2e/harness.rs` with container setup
- [x] Implement self-signed JWT generation for REST API auth
- [x] Implement tenant/worker-token creation via REST API
- [x] Create `sdk-rust/tests/e2e/fixtures/mod.rs`
- [x] Implement `sdk-rust/tests/e2e/fixtures/workflows.rs` (DoublerWorkflow, EchoWorkflow, FailingWorkflow, StatefulWorkflow, TaskSchedulingWorkflow, TimerWorkflow, MultiTaskWorkflow)
- [x] Implement `sdk-rust/tests/e2e/fixtures/tasks.rs` (EchoTask, SlowTask)
- [x] Implement `sdk-rust/tests/e2e/workflow_tests.rs` (4 tests passing)
- [x] Implement `sdk-rust/tests/e2e/task_tests.rs` (2 tests passing)
- [x] Implement `sdk-rust/tests/e2e/state_tests.rs` (1 test passing)
- [x] Implement `sdk-rust/tests/e2e/timer_tests.rs` (2 tests passing)
...
- [x] Implement `sdk-rust/tests/e2e/promise_tests.rs` (2 tests)
- [x] Implement `sdk-rust/tests/e2e/child_workflow_tests.rs` (3 tests)
- [x] Implement `sdk-rust/tests/e2e/error_tests.rs` (2 tests)
- [x] Implement `sdk-rust/tests/e2e/concurrency_tests.rs` (2 tests)
...
**Note**: `sdk-rust/tests/e2e/replay_tests.rs` was not implemented as determinism violation detection is better tested at the unit level with controlled replay scenarios. The E2E tests focus on integration with the real server.
