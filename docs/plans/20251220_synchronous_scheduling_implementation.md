...
- `sdk-rust/sdk/src/workflow/task_submitter.rs` - Delete entire file
- `sdk-rust/sdk/src/client/grpc_task_submitter.rs` - Delete entire file
- `sdk-rust/sdk/src/client/mod.rs` - Remove exports
- `sdk-rust/sdk/src/workflow/mod.rs` - Remove export

#### 2.4 Update FlovynClient Builder

**File**: `sdk-rust/sdk/src/client/builder.rs`

Remove task_submitter configuration.

#### 2.5 Update MockWorkflowContext

**File**: `sdk-rust/sdk/src/testing/mock_workflow_context.rs`

Update mock to match new sync API.

#### 2.6 Update All Examples

**Files**: `sdk-rust/examples/**/*.rs`
...
### SDK Changes - Cleanup
- [x] 3.1 Delete `sdk-rust/sdk/src/workflow/task_submitter.rs`
- [x] 3.2 Delete `sdk-rust/sdk/src/client/grpc_task_submitter.rs`
- [x] 3.3 Update `sdk-rust/sdk/src/workflow/mod.rs` exports
- [x] 3.4 Update `sdk-rust/sdk/src/client/mod.rs` exports
