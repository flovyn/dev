...
The Rust SDK (`sdk-rust/sdk/src/workflow/context_impl.rs`) already implements sophisticated replay:
...
Create `sdk-rust/ffi/src/context.rs` with the core replay-aware context.

**File:** `sdk-rust/ffi/src/context.rs`
...
**File:** `sdk-rust/ffi/src/context.rs` (result enums)
...
**File:** `sdk-rust/ffi/src/worker.rs`
...
**File:** `sdk-rust/ffi/src/activation.rs`
...
**File:** `sdk-rust/ffi/src/error.rs`
...
**File:** `sdk-rust/ffi/src/context.rs` (tests module)
...
**File:** `sdk-rust/ffi/tests/context_integration.rs`
...
### Phase 1: Create FfiWorkflowContext ✅
- [x] Create `sdk-rust/ffi/src/context.rs` module
...
**Key Files:**
- `sdk-rust/core/src/main/kotlin/ai/flovyn/sdk/workflow/WorkflowContext.kt` - Interface
- `sdk-rust/core/src/main/kotlin/ai/flovyn/sdk/workflow/WorkflowContextImpl.kt` - Implementation
- `sdk-rust/core/src/main/kotlin/ai/flovyn/sdk/worker/WorkflowWorker.kt` - Worker loop
- `sdk-rust/core/src/main/kotlin/ai/flovyn/core/CoreBridge.kt` - FFI bridge wrapper
