...
- [ ] Create `sdk-rust/ffi/Cargo.toml` with uniffi dependency
- [ ] Add `ffi` to workspace in root `Cargo.toml`
- [ ] Create `sdk-rust/ffi/src/lib.rs` with `uniffi::setup_scaffolding!()`
...
- [ ] Create `sdk-rust/ffi/src/error.rs` with `FfiError` enum
...
- [ ] Export from `sdk-rust/ffi/src/lib.rs`
...
- [ ] Create `sdk-rust/ffi/src/activation.rs`
...
- [ ] Create `sdk-rust/ffi/src/command.rs`
...
- [ ] Create `sdk-rust/ffi/src/worker.rs`
...
- [ ] Create `sdk-rust/ffi/src/client.rs`
...
- [ ] Create `sdk-rust/ffi/src/config.rs`
...
- [ ] Create `sdk-rust/ffi/src/types.rs` for re-exported/wrapped types
...
- [ ] Create `sdk-rust/ffi/uniffi-bindgen.rs` with main function
- [ ] Add `[[bin]]` entry to `sdk-rust/ffi/Cargo.toml`
...
- [ ] Add module-level documentation to `sdk-rust/ffi/src/lib.rs` explaining the FFI API
