...
**Design Document:**
- [Stateright Model Checking Design](../design/20251225_stateright_model_checking.md)

**Prerequisites:**
- [Parallel Execution](./20251220_parallel_execution_implementation.md) (implemented)
- [Sequence-Based Replay](./20251219_sequence_based_replay_implementation.md) (implemented)
...
**File:** `sdk-rust/sdk/tests/model/mod.rs` (new file)
...
**File:** `sdk-rust/sdk/tests/model.rs` (new file)
...
**File:** `sdk-rust/sdk/tests/model/sequence_matching.rs` (new file)
...
**File:** `sdk-rust/sdk/tests/model/sequence_matching.rs`
...
**File:** `sdk-rust/sdk/tests/model/determinism.rs` (new file)
...
**File:** `sdk-rust/sdk/tests/model/join_all.rs` (new file)
...
**File:** `sdk-rust/sdk/tests/model/select.rs` (new file)
...
**File:** `sdk-rust/sdk/tests/model/mod.rs`
...
**File:** `sdk-rust/sdk/tests/model/config.rs` (new file)
...
**File:** `sdk-rust/bin/dev/run-model-check.sh` (new file)
...
**File:** `sdk-rust/sdk/tests/model/README.md` (new file)
...
- [x] Create `sdk-rust/sdk/tests/model/mod.rs`
- [x] Create `sdk-rust/sdk/tests/model/sequence_matching.rs` with basic model
...
- [ ] Create `sdk-rust/sdk/tests/model/determinism.rs` (deferred - covered by sequence_matching)
- [ ] Implement DeterminismModel (deferred)
- [x] Create `sdk-rust/sdk/tests/model/join_all.rs`
...
- [x] Create `sdk-rust/sdk/tests/model/select.rs`
- [x] Implement SelectState and SelectModel
- [x] Implement SelectAction enum
- [x] Add first-wins property
- [x] Update `sdk-rust/sdk/tests/model/mod.rs` with all modules
...
- [x] Create `sdk-rust/bin/dev/run-model-check.sh`
- [x] Make script executable
- [x] Update CLAUDE.md with model checking commands

### Phase 6: Documentation
- [x] Add module-level documentation to `sdk-rust/sdk/tests/model/mod.rs`
