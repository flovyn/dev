...
**File:** `sdk-rust/sdk/tests/model/bridge.rs` (new file)
...
**File:** `sdk-rust/sdk/tests/model/comparison.rs` (new file)
...
### Phase 1: Model-to-Implementation Bridge
- [x] Create `sdk-rust/sdk/tests/model/bridge.rs`
...
- [x] Update `sdk-rust/sdk/tests/model/mod.rs` to include bridge module

### Phase 2: Comparison Tests
- [x] Create `sdk-rust/sdk/tests/model/comparison.rs`
...
- [x] Update `sdk-rust/sdk/tests/model/mod.rs` to include comparison module
