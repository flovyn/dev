...
- `sdk-rust/sdk/src/workflow/context_impl.rs` - Main fix location
- `sdk-rust/sdk/src/error.rs` - Added `TaskFailed` error variant
...
- Kotlin SDK reference: `sdk-rust/sdk/kotlin/src/main/kotlin/ai/flovyn/sdk/kotlin/workflow/WorkflowContextImpl.kt`
- Server E2E tests: `sdk-rust/server/app/src/test/kotlin/ai/flovyn/e2e/DurableSleepE2ETest.kt`
