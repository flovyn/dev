...
### Files Changed
- `sdk-rust/sdk/src/workflow/context.rs` - Made `schedule_raw` and `schedule_with_options_raw` synchronous
- `sdk-rust/sdk/src/workflow/context_impl.rs` - Removed `task_submitter`, added client-side ID generation
- `sdk-rust/sdk/src/workflow/command.rs` - Added `max_retries`, `timeout_ms`, `queue` fields to `ScheduleTask`
- Deleted: `sdk-rust/sdk/src/workflow/task_submitter.rs`, `sdk-rust/sdk/src/client/grpc_task_submitter.rs`
