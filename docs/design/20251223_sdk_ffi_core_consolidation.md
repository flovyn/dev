...
**SDK: `sdk-rust/sdk/src/workflow/context_impl.rs`** (3,237 LOC)
```rust
...
**FFI: `sdk-rust/ffi/src/context.rs`** (1,085 LOC)
```rust
...
1. Create `sdk-rust/core/src/workflow/replay_engine.rs`:
   ```rust
